...
function hr() {
  ...
  function a(x, d, D) {
    ...
    for (p in d) v.call(d, p) && !y.hasOwnProperty(p) && (j[p] = d[p]);
    if (x && x.defaultProps)
      for (p in ((d = x.defaultProps), d)) j[p] === void 0 && (j[p] = d[p]);
    return {
      $$typeof: f,
      type: x,
      key: b,
    ...
    Fe ||
      ...
      import.meta.env.NODE_ENV !== "production" &&
        (function () {
            ...
            return !!(
              ...
              (typeof e == "object" &&
                ...
                (e.$$typeof === b ||
                  ...
                  e.$$typeof === a ||
                  e.$$typeof === x ||
                  e.$$typeof === d || // This needs to include all possible module reference object
          ...
          var se = S.ReactCurrentDispatcher,
            ie;
          function ee(e, r, t) {
            {
              if (ie === void 0)
...
` + o[g].replace(" at new ", " at ");
          ...
          function te(e, r, t) {
            if (e == null) return "";
            if (typeof e == "function") return Be(e, We(e));
          ...
          function sr(e, r, t, n, l) {
            {
              var u,
                ...
                C = null;
              t !== void 0 && (Oe(t), (o = "" + t)),
                rr(r) && (Oe(r.key), (o = "" + r.key)),
                er(r) && ((C = r.ref), tr(r, l));
              for (u in r)
                Y.call(r, u) && !$e.hasOwnProperty(u) && (s[u] = r[u]);
              if (e && e.defaultProps) {
                var g = e.defaultProps;
                for (u in g) s[u] === void 0 && (s[u] = g[u]);
              }
              if (o || C) {
                var A =
                  typeof e == "function"
          ...
          var fe = S.ReactCurrentOwner,
            Se = S.ReactDebugCurrentFrame;
          function U(e) {
            if (e) {
              var r = e._owner,
                t = te(e.type, e._source, r ? r.type : null);
          ...
          function ze(e, r, t, n, l, u) {
            {
              ...
              if (s) {
                ...
                if (O !== void 0)
                  if (n)
                    if (ce(O)) {
                      for (var F = 0; F < O.length; F++) Le(O[F], e);
              ...
              if (Y.call(r, "key")) {
                var N = T(e),
                  R = Object.keys(r).filter(function (wr) {
                    return wr !== "key";
                  }),
                  ge =
                    R.length > 0
...
const br = ({ sendMessage: c, sendingMessage: f }) => {
  ...
  Pr = ({ message: c, sender: f, showName: w }) => {
    const v = f.role === "user";
    return /* @__PURE__ */ i.jsxs("div", {
  ...
  xr = ({ setUser: c }) => {
    const [f, w] = M(""),
      ...
      y = () => {
        f.trim() !== "" &&
          v.trim() !== "" &&
          c(f, v, "1db2e22a-746e-4324-98df-572c5996e5da");
      };
  ...
  mr = ({ messages: c, user: f, setUser: w, handleSendMessage: v }) => {
    const m = Z(null);
    _(() => {
  ...
  Cr = () => {
    ...
    const $ = () => {
        (b.current = new WebSocket("ws://localhost:2456")),
          (b.current.onopen = () => {
            var E;
            console.log("WebSocket connection established"),
              ...
              (B.current = setInterval(() => {
                var P, Q;
                ((P = b.current) == null ? void 0 : P.readyState) ===
                  WebSocket.OPEN &&
                  ((Q = b.current) == null ||
    ...
    const h = () => {
      ...
      oe = async (E) => {
        ...
        const Q = await fetch("http://localhost:4444/api/v1/webchat/message", {
          method: "POST",
          headers: {
        ...
        if (Q.status === 200) {
          ...
          y((k) => k.filter((G) => G.id !== P)), alert("Error sending message");
      };
    return /* @__PURE__ */ i.jsxs("div", {
      className: "h-screen w-screen",
      children: [
        /* @__PURE__ */ i.jsxs("button", {
          className:
  ...
  Dr = (c) => {
    q.createRoot(c).render(
      /* @__PURE__ */ i.jsx(we.StrictMode, {
        children: /* @__PURE__ */ i.jsx(Cr, {}),
      })
    );
  };
export { Dr as renderWebChat };
